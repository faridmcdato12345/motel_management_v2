<template>
    <Teleport to="body">
        <nav
            class="bottom-0 left-0 px-4 fixed bg-blue-400 backdrop-blur-md dark:bg-gray-900/30 md:dark:border-white/20 pt-2 pb-1 shadow-md border-t border-white/20 dark:border-gray-800 w-full md:rounded-2xl md:mb-12 md:w-[750px] md:left-1/2 md:-translate-x-1/2 duration-200 ease-in-out z-20">
